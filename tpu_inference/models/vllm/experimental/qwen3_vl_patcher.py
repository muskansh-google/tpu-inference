...
def apply_qwen3_vl_patches(vllm_model):
    ...
    # 3. Override deepstack setter to avoid stateful updates of native vLLM variables
    ...
    # 4. Override deepstack getter to prefer JAX-compatible cached tensors
    ...
    # 5. Patch embed_input_ids to pack Deepstack vision features into main text embeddings
    ...
    # 6. Patch forward to unpack vision features and restore them before execution
